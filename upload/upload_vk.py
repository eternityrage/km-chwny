...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "💬 Kim Chaewonya Daily!\n\n#fitness #wellness #lifestyle #kimchaewonya"
        ...
        video = upload.video(
            ...
            name=title or 'Kim Chaewonya Video',
...
def main():
    ...
    title = sys.argv[3] if len(sys.argv) > 3 else "Kim Chaewonya"
